...
1) **Planification et préparation**  
   ...
   Rassembler la documentation pertinante  
   Etablir une équipe d'audit et planifier  
2) **Rassembler les informations**  
   Revoir les procédures et les règles  
   Mener des interviews internes  
   Collecter des infos techniques  
3) **Evaluation des risques**  
   Identifier les menaces et les biens  
   Evaluer les vulnérabilités  
   Déterminer le niveau de risque  
4) **Exécution de l'Audit**  
   Réaliser les tests techniques  
   Vérifier la conformité  
   Evaluer les controles (Evaluer l'efficacité de la sécurité des contrôles de sécurité et des pratiques)  
5) **Analyse et évaluation**  
   Analyser les trouvailles  
   Comparer avec les standards  
   Prioriser les problèmes  
6) **Rapport**  
   Documenter ce qui est trouvé  
   Fournir des recommandations  
   Présenter les résultats  
7) **Remédiation**  
   Développer des plans de remédiations  
